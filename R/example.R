...
#'
#' @description This is just an example on how to use this package to generate
#' random values from a Poisson multinomial distribution in order to obtain
#' a point estimate of the number of individuals detected by mobile network in a region.
#'
#' @details This is a script that shows how to use the functions of this package
#' to compute a point estimate of the number individuals detected by the network
#' in each region and the number of individuals moving from one region to
#' another. From the set of random values
#' one can obtain any point estimate: mean. mode, median.
